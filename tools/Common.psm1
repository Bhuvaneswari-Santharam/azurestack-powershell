...
function New-AzureCertSp
{
    ...
    Get-ChildItem -Path "cert:\LocalMachine\My" | Where-Object Subject -Match $CertificateName | Remove-Item -Force
    $subjectName = "CN=" + $CertificateName
    $certificate = New-SelfSignedCertificate -CertStoreLocation "cert:\LocalMachine\My" -Subject $subjectName -KeySpec KeyExchange
